...
const Apiunifsd = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axios.post('http://127.0.0.1:8000/askunifsd', { question });
      const botChat = { type: 'fsdbot', message: response.data.response };
  ...
  return (
    <div className="main" id = "unifsdmain">
      <div className="chats" id = "unifsdsalman">
      ...
      <div className='chatfooter' id = "unifsdumair">
        <div className="inp" id = "unifsdabubakar">
          <input type="text" placeholder="Ask About University Of Faisalabad" value={question} onChange={handleInputChange} disabled={isLoading}/>
